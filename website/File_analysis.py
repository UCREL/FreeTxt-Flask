...
def generate_pdf():
    if request.method == 'POST':
        ...
        rendered_html = render_template('report.html',
                                        ...
                                        SentimentPlotbar=SentimentPlotbar,
                                        wordtree=wordtree,
                                        sentiment_explanation=sentiment_explanation,
                                        word_cloud_image_src=word_cloud_image_src,
                                        summary=summary,
    ...
    try:
        ...
        if has_english and not has_welsh:
            ...
            english_path = os.path.abspath(os.path.join(
                'website/static/temp', english_filename))
            welsh_path = os.path.abspath(os.path.join(
                'website/static/temp', welsh_filename))
...
def add_logo_and_text_to_image(image_path):
    ...
    draw.text((120, wc_image.height - 45),
              "Visualisation by", (0, 0, 0), font=font)
